...
public class Properties {
    ...
    public static final String[] SLACK_BOT_ERROR = new String[] {
	    "I'm sorry, I don't understand that, try _idbot help_",
	    "I don't get that. Maybe try _idbot help_", 
	    "I'm sorry I haven't a clue. Try _idbot help_ ",
	    "¯\\_(ツ)_/¯ try _idbot help_"};
    ...
    public static final String[] SLACK_BOT_STATUS = new String[] {
	    "*Request URL:* http://idbot/lovelife \n"
		    + "*Request methods:* GET \n"
		    + "*Status Code:* 404 Not Found",
	    "*Request URL:* http://idbot/emotion \n"
		    + "*Request methods:* GET \n"
		    + "*Status Code:* 500 internal server error",
	    "*Request URL:* http://idbot/action/kill/humans \n"
		    + "*Request methods:* GET \n"
		    + "*Status Code:* 403 forbidden", };
    public static final String CHUCK_NORRIS_JOKE_API = "https://api.icndb.com/jokes/random";
}
